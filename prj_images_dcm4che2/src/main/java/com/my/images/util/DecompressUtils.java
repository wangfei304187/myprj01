...
public class DecompressUtils
{
    ...
    public static Object decompress(byte[] inputData, int pixelRepresentation) throws UnsupportedOperationException
    {
        ...
        /*@formatter:off*/
        Mat mat = Imgcodecs.dicomJpgMatRead(buf, dcmFlags, Imgcodecs.IMREAD_UNCHANGED); // CV_16UC1, CV_8UC3, ...
        /*@formatter:on*/
