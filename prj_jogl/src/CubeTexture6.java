...
public class CubeTexture6 implements GLEventListener {
	...
	public void display(GLAutoDrawable drawable) {
		...
		//new AWTGLReadBufferUtil(gl.getGLProfile(), false).readPixelsToBufferedImage(gl, awtOrientation)
	}
...
//			glTexParameteri(GL_TEXTURE_2D_ARRAY,GL_TEXTURE_WRAP_T,GL_CLAMP_TO_EDGE);
			gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_LUMINANCE,
					textureData.getWidth(), textureData.getHeight(), 0,
					GL.GL_LUMINANCE, GL4.GL_UNSIGNED_BYTE,
	...
	public static void main(String[] args) {
		...
		CubeTexture6 app = new CubeTexture6();
		app.showFrame();
	}
