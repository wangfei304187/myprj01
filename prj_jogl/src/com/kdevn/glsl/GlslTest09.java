...
//		mvp = mvp.translate(-0.5f, -0.5f, -2.5f);
//		mvp = mvp.translate(0f, 0f, -5f);
//		mvp = mvp.translate(0f, 0f, 0f);
		...
		Matrix4f projection = new Matrix4f().ortho(
		 ...
		 // Matrix4f projection = new Matrix4f().perspective(45.0f, this.width*1f/this.height, 1.0f, 20.0f);
