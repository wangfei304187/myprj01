...
public class GlslTest04
{
    ...
    /*@formatter:off*/
    private String vertexShaderSource = "#if __VERSION__ >= 130\n"
            ...
            + "   TexCoord=aTexCoord;\n"
            + "} ";
    private String fragmentShaderSource = "#if __VERSION__ >= 130\n"
            + // GLSL 130+ uses in and out
            "  #define attribute in\n"
            + // instead of attribute and varying
            "  #define varying out\n"
    ...
    private void loadVertex(GL2 gl, int vao, int vbo, int ebo, float[] vertices)
    {
        ...
        try
        {
            ...
            InputStream is2 = GlslUtils.getUrl("images/smile_32px.png").openStream();
