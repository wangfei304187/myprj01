...
public class CubeTexture3D_1 implements GLEventListener
{
    ...
    // private int[][][][] image = new int[w][h][depth][3];

    private byte[] image = new byte[w * h * depth];
        ...
        for (s = 0; s < 16; s++)
        {
            for (t = 0; t < 16; t++)
            {
                for (r = 0; r < 16; r++)
                {
                    ...
                    // image[r][t][s][1] = t * 17;
                    // image[r][t][s][2] = r * 17;
                    image[s * t + r] = (byte) ((s * 17 << 16) + (t * 17 << 8) + r * 17);
                }
            }
        }
    }
    ...
    public void display(GLAutoDrawable drawable)
    {
        ...
        // Front Face (ABCD)
        gl.glTexCoord3f(0.0f, 0.0f, 1f);
        gl.glVertex3f(-1.0f, -1.0f, 1.0f);
        gl.glTexCoord3f(1.0f, 0.0f, 1f);
        gl.glVertex3f(1.0f, -1.0f, 1.0f);
        gl.glTexCoord3f(1.0f, 1.0f, 1f);
        gl.glVertex3f(1.0f, 1.0f, 1.0f);
        gl.glTexCoord3f(0.0f, 1.0f, 1f);
        gl.glVertex3f(-1.0f, 1.0f, 1.0f);
        // Back Face (EFGH)
        ...
        //        gl.glTexCoord3f(0.0f, 0.0f, 0.0f); gl.glVertex3f(-2.25f, -1.0f, 0.0f);
        //        gl.glTexCoord3f(0.0f, 1.0f, 0.0f); gl.glVertex3f(-2.25f, 1.0f, 0.0f);
        //        gl.glTexCoord3f(1.0f, 1.0f, 1.0f); gl.glVertex3f(-0.25f, 1.0f, 0.0f);
        //        gl.glTexCoord3f(1.0f, 0.0f, 1.0f); gl.glVertex3f(-0.25f, -1.0f, 0.0f);
        //
        //        gl.glTexCoord3f(0.0f, 0.0f, 1.0f); gl.glVertex3f(0.25f, -1.0f, 0.0f);
        //        gl.glTexCoord3f(0.0f, 1.0f, 1.0f); gl.glVertex3f(0.25f, 1.0f, 0.0f);
        //        gl.glTexCoord3f(1.0f, 1.0f, 0.0f); gl.glVertex3f(2.25f, 1.0f, 0.0f);
        //        gl.glTexCoord3f(1.0f, 0.0f, 0.0f); gl.glVertex3f(2.25f, -1.0f, 0.0f);
    ...
    public void init(GLAutoDrawable drawable)
    {
        ...
        try
        {
            ...
            //
            // gl.glTexSubImage3D(GL2ES3.GL_TEXTURE_2D_ARRAY, 0, 0, 0, k, width, height, 1, GL.GL_RGB,
            // GL.GL_UNSIGNED_BYTE, textureData.getBuffer());
            // }

            gl.glTexImage3D(GL2ES2.GL_TEXTURE_3D, 0, GL.GL_RGB, w, h, depth, 0, GL.GL_RGB, GL.GL_UNSIGNED_BYTE,
                    Buffers.newDirectByteBuffer(image));
            gl.glEnable(GL2ES2.GL_TEXTURE_3D);
    ...
    public static void main(String[] args)
    {
        ...
        CubeTexture3D_1 app = new CubeTexture3D_1();
        app.showFrame();
    }
    ...
    public CubeTexture3D_1()
    {
        ...
        CubeTexture3D_1.glcanvas = new GLJPanel(capabilities);
        CubeTexture3D_1.glcanvas.addGLEventListener(this);
        CubeTexture3D_1.glcanvas.setSize(400, 400);
        CubeTexture3D_1.glcanvas.setPreferredSize(new Dimension(400, 400));

        MouseAdapter ml = new CustomMouseAdapter();
        CubeTexture3D_1.glcanvas.addMouseListener(ml);
        CubeTexture3D_1.glcanvas.addMouseMotionListener(ml);
        ...
        resetBtn.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                CubeTexture3D_1.glcanvas.repaint();
            }
        });
    ...
    public void showFrame()
    {
        ...
        frame.getContentPane().add(CubeTexture3D_1.glcanvas, BorderLayout.CENTER);
